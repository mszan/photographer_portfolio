"""
Django settings for gerd project.
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'galleries.context_processors.get_all_galleries',
                'infos.context_processors.get_all_socials',
            ],
        },
    },
]

WSGI_APPLICATION = 'gerd.wsgi.application'
